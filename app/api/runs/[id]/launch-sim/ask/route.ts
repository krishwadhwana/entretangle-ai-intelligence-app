...
- CAC CAP + FATIGUE: paid-attributed first-time orders each step cannot exceed (ad spend ÷ benchmark CAC), then that ceiling tapers with launch-age and reachable-audience saturation so paid acquisition does not stay flat forever. Organic / owned / word-of-mouth demand is not capped away by paid CAC; it is limited by its own reach → checkout funnel.
